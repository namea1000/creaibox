...
export default function VideoEditorAiAssetsPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-cyan-400/20 bg-cyan-400/10 p-4 text-xs leading-5 text-cyan-100">
        연결 예정:
        <br />
        • Image Studio
        <br />
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-black/30 p-3 hover:border-cyan-400/50">
      <div className="flex items-center gap-3">
        ...
        <button className="rounded-lg border border-white/10 p-2 text-zinc-400 hover:border-cyan-400">
          <Plus size={14} />
        </button>
      </div>
    </div>
...
function ActionCard({
  ...
  return (
    <button className="rounded-xl border border-white/10 bg-black/30 p-3 text-left hover:border-cyan-400/50">
