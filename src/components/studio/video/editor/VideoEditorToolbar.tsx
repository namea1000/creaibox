    ...
    <div className="flex h-14 shrink-0 items-center justify-between border-b border-white/10 bg-[#0b0b10] px-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md bg-cyan-400 px-4 py-2 text-sm font-black text-black hover:bg-cyan-300"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md border border-white/10 px-4 py-2 text-sm font-bold text-zinc-300 hover:border-cyan-400"
        >
          <Pause size={16} />
          정지
        </button>
...
function ToolButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`flex items-center gap-2 rounded-md border px-3 py-2 text-sm font-bold transition disabled:cursor-not-allowed disabled:opacity-30 ${active
...
function ToolIcon({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className="rounded-md border border-white/10 p-2 text-zinc-400 hover:border-cyan-400 hover:text-cyan-200 disabled:cursor-not-allowed disabled:opacity-30"
    >
      <Icon size={16} />
    </button>
  );
