...
export default function VideoEditorInspector({
  ...
  return (
    <aside className="w-[380px] shrink-0 border-l border-white/10 bg-[#0d0d12]">
      <div className="h-full overflow-y-auto p-4">
        <h2 className="mb-4 text-lg font-black">Inspector</h2>
        ...
        <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-white/10 p-2 text-zinc-500 hover:border-red-400 hover:text-red-300"
                  >
                    <Trash2 size={15} />
                  </button>
                </div>
          ...
          <InspectorCard title="Export Settings">
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-cyan-400/20 bg-cyan-400/10 p-4 text-sm text-cyan-200">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-400 py-3 font-black text-black hover:bg-cyan-300"
              >
                <Download size={17} />
                MP4 내보내기
              </button>
...
function NumberField({
  ...
  return (
    <label className="block">
      ...
      <div className="flex h-11 items-center rounded-xl border border-white/10 bg-black/40 px-3 focus-within:border-cyan-400">
        <input
          type="number"
          value={value}
          min={min}
...
function ActionButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex h-10 items-center justify-center gap-2 rounded-xl border text-xs font-black ${danger
...
function MiniFeature({
  ...
  return (
    <div className="flex h-10 items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/30 text-xs font-bold text-zinc-500">
      <Icon size={14} />
      {label}
    </div>
  );
