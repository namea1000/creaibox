      ...
      <div className="max-w-4xl mx-auto px-6 py-20 relative z-10">
        ...
        <div className="border-b border-slate-200 pb-8 mb-12 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-white text-slate-600 text-xs font-bold tracking-widest uppercase shadow-sm">
            <Scale size={12} className="text-blue-600" /> Terms & Conditions
          </div>
          <h1 className="text-3xl md:text-4xl font-black tracking-tighter text-slate-950">
            서비스 이용약관
          </h1>
          <p className="text-xs md:text-sm text-slate-500 font-medium">
            본 약관은 <span className="text-slate-900 font-bold">2026년 05월 18일</span>부터 적용됩니다. 크리에이박스 서비스를 이용하시기 전에 본 약관을 주의 깊게 읽어주시기 바랍니다.
          </p>
        </div>
        ...
        <div className="space-y-10 text-sm md:text-base leading-relaxed text-slate-700 font-medium">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">02.</span> 약관의 명시와 개정
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">03.</span> 회원가입 및 계약 성립
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">04.</span> 서비스의 제공 및 인공지능 생성물의 저작권
            </h3>
            <div className="text-slate-600 text-xs md:text-sm pl-6 space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1 text-slate-600">
                <li>회원이 서비스를 통해 독립적으로 생성한 모든 콘텐츠(텍스트, 이미지, 영상, 오디오 등)의 저작권 및 소유권은 전적으로 <span className="text-slate-900 font-bold">해당 콘텐츠를 생성한 회원</span>에게 귀속됩니다.</li>
          ...
          <div className="space-y-3">
            ...
            <div className="text-slate-600 text-xs md:text-sm pl-6 space-y-2">
              <p>회사는 월 구독형 멤버십(유료 서비스)을 제공할 수 있으며, 환불 및 청약철회 조건은 전자상거래법 및 콘텐츠산업 진흥법을 준수합니다.</p>
              <ul className="list-disc pl-5 space-y-1 text-slate-600">
                <li><span className="text-slate-900 font-bold">월 구독(멤버십) 결제일</span>로부터 7일 이내에 AI 글쓰기 등 어떠한 서비스 이용 내역도 존재하지 않는 결제 건에 대해서는 100% 전액 결제 취소 및 환불이 보장됩니다.</li>
                <li>결제 후 7일을 경과하였거나 서비스를 이용한 상태에서 구독을 중도 해지할 경우, 사용한 일수에 준하는 멤버십 기본 이용료 및 PG사 금융 수수료(정가의 10%)를 정산 공제한 후 잔여 금액을 환불해 드립니다.</li>
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">06.</span> 회원의 의무 및 금지사항
            </h3>
            <div className="text-slate-600 text-xs md:text-sm pl-6 space-y-2">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">07.</span> 면책 조항 (Disclaimers)
            </h3>
            <ul className="list-disc pl-11 text-slate-600 text-xs md:text-sm space-y-1">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">08.</span> 관할 법원
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
