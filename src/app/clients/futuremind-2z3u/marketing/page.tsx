    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-16 space-y-24">
      ...
      <div className="space-y-6">
        <div className="border-b border-neutral-800 pb-4">
          <span className="text-xs font-mono text-cyan-400 font-bold uppercase">SUCCESS PROCESS</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ROADMAP_STEPS.map((step, idx) => (
            <div
              key={idx}
              className="p-8 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-cyan-500/60 transition-all space-y-4 shadow-xl flex flex-col justify-between"
            >
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 border-b border-neutral-800 pb-4">
          <div>
            <span className="text-xs font-mono text-cyan-400 font-bold uppercase">INDUSTRY MATRIX</span>
            ...
            <tbody className="divide-y divide-neutral-800/80 text-neutral-300">
              {INDUSTRY_MATRIX.map((row, idx) => (
                <tr key={idx} className="hover:bg-neutral-900/40 transition-colors">
                  ...
                  <td className="py-4 px-6 font-mono text-cyan-400 font-bold text-base whitespace-nowrap">{row.roi}</td>
                  <td className="py-4 px-6 font-medium text-cyan-300">{row.caseStudy}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        <div className="text-center space-y-2">
          <span className="text-xs font-mono font-bold text-cyan-400 uppercase">FAQ</span>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-5 text-left flex items-center justify-between gap-4 font-bold text-white hover:text-cyan-400 transition-colors cursor-pointer"
                >
