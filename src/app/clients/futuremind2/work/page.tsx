...
import { ArrowRight, Check, Building2, Rocket, HeartHandshake, CheckCircle2 } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-16 space-y-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-8 rounded-2xl bg-[#141414] border border-neutral-800 space-y-6 flex flex-col justify-between shadow-xl">
          <div className="space-y-4">
            <div className="w-14 h-14 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-[#f95700]">
              <Building2 size={28} />
            </div>
            <div className="space-y-1">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">SEGMENT 01</span>
            ...
            <ul className="space-y-2.5 pt-3 border-t border-neutral-800 text-xs text-neutral-300">
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 기관 맞춤형 AI 솔루션 및 SW 기능 구현</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 정부·공공기관 입찰 100% 전문 제안 기획</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 임직원 생성형 AI 실무 역량 강화 워크숍</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 사내 데이터 보안 RAG 챗봇 구축</li>
            </ul>
          </div>
          <Link
            href="/development"
            className="inline-flex items-center justify-center gap-2 py-3 rounded-lg bg-neutral-900 hover:bg-[#f95700] hover:text-white border border-neutral-800 text-xs font-bold text-neutral-300 transition-all cursor-pointer"
          >
        ...
        <div className="p-8 rounded-2xl bg-[#141414] border border-neutral-800 space-y-6 flex flex-col justify-between shadow-xl">
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">SEGMENT 02</span>
            ...
            <ul className="space-y-2.5 pt-3 border-t border-neutral-800 text-xs text-neutral-300">
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> IP 디딤돌 지원사업 & 특허 출원 컨설팅</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 창업자를 위한 원스톱 바우처 제안서 작성</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 90일 실전 매출 전환 인플루언서 제휴</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 전환율 3.2배 고효율 랜딩/퍼널 설계</li>
            </ul>
          </div>
          <Link
            href="/planning"
        ...
        <div className="p-8 rounded-2xl bg-[#141414] border border-neutral-800 space-y-6 flex flex-col justify-between shadow-xl">
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">SEGMENT 03</span>
            ...
            <ul className="space-y-2.5 pt-3 border-t border-neutral-800 text-xs text-neutral-300">
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 대학생 AI 포트폴리오 & 취업 부트캠프</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 청소년 창의 융합 및 미래 기술 체험</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 신중년 맞춤형 노코드 & 매장 자동화</li>
              <li className="flex items-center gap-2"><Check size={14} className="text-[#f95700] shrink-0" /> 4차산업 실감 체험 힐링캠프 운영</li>
            </ul>
          </div>
          <Link
            href="/education"
      ...
      <div className="rounded-2xl bg-[#141414] border border-neutral-800 p-8 sm:p-10 space-y-6">
        <h3 className="text-lg font-bold text-white flex items-center gap-2">
          <CheckCircle2 size={20} className="text-[#f95700]" /> 미래교육문화협회의 5대 사회적 핵심 가치
        </h3>
