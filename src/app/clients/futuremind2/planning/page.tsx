    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-16 space-y-24">
      ...
      <div className="space-y-6">
        <div className="border-b border-neutral-800 pb-4">
          <span className="text-xs font-mono text-[#f95700] font-bold uppercase">6 CORE PILLARS</span>
          <h2 className="text-xl sm:text-2xl font-black text-white">퓨처마인드 6대 종합 기획 솔루션</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 01</span>
            ...
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">실전 마케터 1:1 매칭</span>
          </div>

          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 02</span>
            ...
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">전문 디자이너 퍼널 설계</span>
          </div>

          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 03</span>
            ...
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">지원사업 선정 성공률 92%</span>
          </div>

          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 04</span>
              <h3 className="text-lg font-bold text-white">4. 정부 바우처 기획</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">
                K-스타트업, 혁신바우처, 기술개발 바우처 활용 (정부지원 70% + 자부담 30%). 바우처로 마케팅, 웹개발, 디자인 전액 해결
              </p>
            </div>
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">최대 1,000만원 정부 지원</span>
          </div>

          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 05</span>
            ...
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">변리법인 세움 20년 자문단</span>
          </div>

          <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-4 shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
              <span className="text-[10px] font-mono text-[#f95700] font-bold">PILLAR 06</span>
            ...
            <span className="text-xs font-bold text-[#f95700] pt-2 border-t border-neutral-800">정부·공공 입찰 100% 대행</span>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-[#141414] border border-neutral-800 p-8 sm:p-10 space-y-8 shadow-2xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <span className="text-xs font-mono font-bold text-[#f95700] uppercase">PATENT & IP ROADMAP</span>
          ...
          <div className="flex items-center gap-6 shrink-0 bg-neutral-900 p-4 rounded-xl border border-neutral-800 font-mono text-center">
            <div>
              <span className="text-2xl font-black text-[#f95700]">92%</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {IP_ROADMAP_STEPS.map((step, idx) => (
            <div key={idx} className="p-4 rounded-xl bg-neutral-900/80 border border-neutral-800 space-y-2">
              <h4 className="text-xs font-bold text-[#f95700]">{step.step}</h4>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 border-b border-neutral-800 pb-4">
          <div>
            <span className="text-xs font-mono text-[#f95700] font-bold uppercase">PUBLIC BIDDING RADAR</span>
            ...
            <tbody className="divide-y divide-neutral-800/80 text-neutral-300">
              {BID_NOTICES.map((bid, idx) => (
                <tr key={idx} className="hover:bg-neutral-900/40 transition-colors">
                  ...
                  <td className="py-4 px-6 font-mono text-[#f95700] font-bold">{bid.budget}</td>
