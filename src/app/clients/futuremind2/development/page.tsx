    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-16 space-y-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 space-y-2 text-center shadow-xl">
          <span className="text-xs font-mono font-bold text-[#f95700]">VISION 01</span>
        ...
        <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 space-y-2 text-center shadow-xl">
          <span className="text-xs font-mono font-bold text-[#f95700]">VISION 02</span>
        ...
        <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800 space-y-2 text-center shadow-xl">
          <span className="text-xs font-mono font-bold text-[#f95700]">VISION 03</span>
      ...
      <div className="space-y-6">
        <div className="border-b border-neutral-800 pb-4">
          <span className="text-xs font-mono text-[#f95700] font-bold uppercase">10 CORE DEVELOPMENT FIELDS</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {DEV_10_PILLARS.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-8 rounded-2xl bg-[#141414] border border-neutral-800 hover:border-[#f95700]/60 transition-all space-y-6 shadow-xl flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-[#f95700]">
                      <Icon size={24} />
                    </div>
                  ...
                  <div className="space-y-2 pt-2 border-t border-neutral-800 text-xs text-neutral-300 font-mono">
                    <p className="flex items-center gap-2"><Check size={13} className="text-[#f95700]" /> <strong className="text-neutral-500">1단계:</strong> {item.p1}</p>
                    <p className="flex items-center gap-2"><Check size={13} className="text-[#f95700]" /> <strong className="text-neutral-500">2단계:</strong> {item.p2}</p>
                    <p className="flex items-center gap-2"><Check size={13} className="text-[#f95700]" /> <strong className="text-neutral-500">3단계:</strong> {item.p3}</p>
                    <p className="flex items-center gap-2"><Check size={13} className="text-[#f95700]" /> <strong className="text-neutral-500">4단계:</strong> {item.p4}</p>
                  </div>
                </div>
