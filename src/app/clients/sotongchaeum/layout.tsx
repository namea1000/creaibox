...
export async function generateMetadata(): Promise<Metadata> {
  const { naverKey, googleKey } = await getClientSiteVerificationKeys("sotongchaeum");
  ...
  const meta: Metadata = {
    ...
    openGraph: {
      ...
      description:
        "공공행사부터 마을축제까지 깔끔하게! 소통과채움 협동조합의 감성 교육 프로그램 및 전문 장비 렌탈 서비스를 만나보세요.",
      url: "https://sotongchaeum.com",
      siteName: "소통과 채움",
      images: [
        {
          url: getCustomClientAssetUrl("sotongchaeum", "hero-bg.webp"),
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      images: [getCustomClientAssetUrl("sotongchaeum", "hero-bg.webp")],
    },
  };
...
export default function SotongchaeumLayout({
  children,
}: {
