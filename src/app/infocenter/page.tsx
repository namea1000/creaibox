  ...
  return (
    <div className="mt-6 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20 px-6">
      ...
      <div className="relative overflow-hidden rounded-[40px] p-10 bg-gradient-to-br from-blue-600 to-indigo-950 text-white shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-8 text-left mb-8">
        ...
        <Link 
          href="/infocenter/writing?category=free" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col">
          <BoardSection 
            ...
            listHref="/infocenter/list/notice" 
            writeHref="/infocenter/writing?category=notice"
          ...
          <BoardSection 
            ...
            listHref="/infocenter/list/free" 
            writeHref="/infocenter/writing?category=free"
          ...
          <BoardSection 
            ...
            listHref="/infocenter/list/qna" 
            writeHref="/infocenter/writing?category=qna"
        ...
        <div className="flex flex-col">
          <BoardSection 
            ...
            listHref="/infocenter/list/tips" 
            writeHref="/infocenter/writing?category=tips"
          ...
          <BoardSection 
            ...
            listHref="/infocenter/list/showcase" 
            writeHref="/infocenter/writing?category=showcase"
          ...
          <BoardSection 
            ...
            listHref="/infocenter/list/faq" 
            writeHref="/infocenter/writing?category=faq"
