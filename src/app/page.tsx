  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 transition-colors duration-300">
      ...
      <main className="pt-0">
        ...
        {/* 가로 퀵 메뉴 바 (Dark Seamless matching Hero Section) */}
        <div className="border-b border-zinc-900/80 bg-[#06080d] sticky top-16 z-40 transition-colors duration-300">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="flex items-center justify-start md:justify-center gap-2 overflow-x-auto py-2.5 scrollbar-none flex-nowrap">
              {[
                ...
                { icon: <PenLine size={16} />, label: "크리에이박스 블로그", href: "/writing/creaibox", color: "text-blue-400 border-zinc-800/90 bg-zinc-900/90 hover:bg-zinc-800 hover:border-blue-500/50" },
