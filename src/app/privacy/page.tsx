      ...
      <div className="max-w-4xl mx-auto px-6 py-20 relative z-10">
        ...
        <div className="border-b border-slate-200 pb-8 mb-12 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-white text-slate-600 text-xs font-bold tracking-widest uppercase shadow-sm">
            <Shield size={12} className="text-blue-600" /> Legal & Privacy
          </div>
        ...
        <div className="space-y-10 text-sm md:text-base leading-relaxed text-slate-700 font-medium">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-955 flex items-center gap-2">
              <span className="text-blue-600 font-mono">02.</span> 처리하는 개인정보의 항목
            </h3>
            <div className="text-slate-600 text-xs md:text-sm pl-6 space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1 text-slate-600">
                <li><span className="text-slate-900 font-bold">수집 항목 (소셜 연동 시):</span> 이메일 주소, 카카오 식별 고유 ID, 프로필 닉네임, 프로필 이미지</li>
                <li><span className="text-slate-900 font-bold">자동 수집 항목:</span> 서비스 이용 기록, 접속 로그, 쿠키, IP 주소, 결제 기록 (유료 서비스 이용 시)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">03.</span> 개인정보의 처리 및 보유 기간
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
              회사는 이용자로부터 개인정보를 수집할 때 동의받은 개인정보 보유 및 이용 기간 또는 법령에 따른 개인정보 보유 및 이용 기간 내에서 개인정보를 처리하고 보유합니다. 원칙적으로 <span className="text-slate-900 font-bold">회원 탈퇴 즉시</span> 이용자의 개인정보는 파기됩니다. 단, 관계 법령(전자상거래법 등)의 규정에 의하여 보존할 필요가 있는 경우, 계약 또는 청약철회 등에 관한 기록은 5년, 대금결제 및 재화 등의 공급에 관한 기록은 5년간 보관됩니다.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">04.</span> 개인정보의 제3자 제공 및 위탁에 관한 사항
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
              회사는 이용자의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 이용자의 사전 동의 없이는 원칙적으로 회사의 서비스와 무관한 제3자에게 제공하지 않습니다. 단, 안정적인 클라우드 인프라 및 인증 생태계 운영을 위해 글로벌 클라우드 백엔드 인프라 서비스인 <span className="text-slate-900 font-bold">Supabase (수파베이스)</span> 시스템에 데이터베이스 관리를 위탁하여 엄격하게 암호화 보관하고 있습니다.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">05.</span> 정보주체의 권리·의무 및 그 행사방법
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">06.</span> 개인정보의 안전성 확보 조치
            </h3>
            <p className="text-slate-600 text-xs md:text-sm pl-6">
          ...
          <div className="space-y-3">
            <h3 className="text-base md:text-lg font-black text-slate-950 flex items-center gap-2">
              <span className="text-blue-600 font-mono">07.</span> 개인정보 보호책임자 및 고충처리 창구
            </h3>
            <div className="text-slate-600 text-xs md:text-sm pl-6 space-y-2">
