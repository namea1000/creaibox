          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 p-0.5 rounded shadow-xs h-9">
              ...
              <div className="relative flex items-center h-full">
                <Calendar size={14} className="absolute left-2.5 text-orange-500 pointer-events-none z-10" />
                <input
                  type="date"
                  value={selectedDate}
                  onChange={(e) => handleDateChange(e.target.value)}
                  max={getKstTodayDateStr()}
                  className="relative z-20 h-full w-[130px] border-0 bg-transparent pl-8 pr-1 text-xs font-bold text-slate-800 dark:text-zinc-200 outline-none cursor-pointer dark:[color-scheme:dark] [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:right-0 [&::-webkit-calendar-picker-indicator]:top-0 [&::-webkit-calendar-picker-indicator]:w-full [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:cursor-pointer"
                />
              </div>
