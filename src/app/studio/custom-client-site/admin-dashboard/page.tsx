...
export default function AdminDashboardPage() {
  ...
  const handleUpdateStatus = (id: string, newStatus: string) => {
    const updated = adminRequests.map((req: any) =>
  ...
  return (
    <div className="min-h-screen bg-[#0d0f14] text-slate-100 font-sans p-6 lg:p-10">
      <div className="mb-6">
        <h1 className="text-2xl font-black text-white">관리자: 커스텀 신청 현황</h1>
        <p className="text-sm text-slate-400 mt-1">고객들이 신청한 커스텀 디자인 요청 내역을 확인하고 상태를 변경합니다.</p>
      </div>
