...
import { 
  ShieldCheck, ExternalLink, Key, Zap, Music, Search, 
...
const leftHub = [
  ...
  { id: 'google_search', storageKey: 'google_search_api_key', name: 'Google Search API', tip: '💡 Tip: 글로벌 실시간 정보 탐색 엔진입니다. 전 세계 최신 정보를 팩트체크하고 자료 조사를 수행합니다. 매일 100건의 검색을 무료 제공합니다.', link: 'https://programmablesearchengine.google.com/' },
...
<p className="text-white font-black text-xs mb-0.5 uppercase tracking-tight">
  사용자 프라이버시 보호 시스템
</p>
<p className="text-slate-200 font-medium tracking-tight">
  모든 키는 서버에 전송되지 않으며, 사용자의 <span className="text-blue-400 font-black">로컬 브라우저에만 암호화 되어 안전하게 보관됩니다.</span>중앙 DB에 저장되지 않아 외부 유출 위협으로부터 원천 차단됩니다.
</p>
                  </div>
                </div>
              </div>
            ...
            <footer className="text-center text-slate-700 text-[9px] mt-12 font-black tracking-[0.3em] uppercase pb-8">
