...
import BulkSearch from "@/app/studio/keyword/[section]/components/BulkSearch";
import RelatedKeywords from "@/app/studio/keyword/[section]/components/RelatedKeywords";
import MorphologyAnalyzer from "@/app/studio/keyword/[section]/components/MorphologyAnalyzer";
import RankTracker from "@/app/studio/keyword/[section]/components/RankTracker";
import RisingTrends from "@/app/studio/keyword/[section]/components/RisingTrends";
import YoutubeKeywords from "@/app/studio/keyword/[section]/components/YoutubeKeywords";
import SeoCompetitor from "@/app/studio/keyword/[section]/components/SeoCompetitor";
import AiStrategy from "@/app/studio/keyword/[section]/components/AiStrategy";
import AutoWorkflow from "@/app/studio/keyword/[section]/components/AutoWorkflow";
import TrendDashboard from "@/app/studio/keyword/[section]/components/TrendDashboard";
...
export default function PublicKeywordSectionClient() {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5 text-[10px] font-bold text-zinc-500">
                <Link href="/keyword-trend" className="hover:text-zinc-350 transition">
                  키워드 트렌드 분석
                </Link>
                <span>/</span>
