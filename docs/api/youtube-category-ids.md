...
| **엔터테인먼트/방송** | `24`         | Entertainment            | 예능, TV방송, BJ/연예인, 키즈                 |
| **코미디/유머**       | `23`         | Comedy                   | 코미디, 유머, 개그, 숏폼 밈                   |
...
| **취미/일상**         | `22`         | People & Blogs           | 일상 브이로그, 라이프스타일, 취미             |
| **여행/이벤트**       | `19`         | Travel & Events          | 국내/해외 여행, 축제, 이벤트                  |
| **IT/기술/컴퓨터**    | `28`         | Science & Technology     | IT 테크 리뷰, 컴퓨터, 전자기기                |
...
| **비영리/사회운동**   | `29`         | Nonprofits & Activism    | 사회 공익, 캠페인, 비영리, 기부               |
