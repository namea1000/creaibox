...
## 16. 💳 PG 심사 대비 약관 및 환불정책 크레딧 문구 완전 삭제

### 주요 변경 사항
- **이용약관 및 환불정책 개정 (`/terms`, `/refund-policy`)**:
  - NHN KCP 정욱환 담당자 요청사항에 따라 재무제표 제출 없이 PG 최종 승인을 획득할 수 있도록, 이용약관 5조 및 환불정책 4대 가이드라인에서 **"단독 크레딧 구매", "크레딧 충전", "크레딧 차감 내역" 등 크레딧 관련 모든 표현을 100% 깔끔하게 삭제** 완료했습니다.
