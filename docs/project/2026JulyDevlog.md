...
* **작업 상세 ([`Sidebar.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/components/layout/Sidebar.tsx))**:
  ...
  - **아우라 메리노(Aura Merino) 서브도메인 `auramerino` 미들웨어 폴더 매핑 및 라이브 URL 개편 ([`middleware.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/middleware.ts), [`clientSites.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/lib/constants/clientSites.ts), [`custom-client-site/page.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/app/studio/custom-client-site/page.tsx))**: 기존 `aura-merino.localhost:3000` 주소를 하이픈 없는 규격 `https://auramerino.creaibox.com`으로 변경하고, 미들웨어(`middleware.ts`)에서 `auramerino` 접속 요청 시 실제 커스텀 사이트 폴더 `/clients/aura-merino`로 자동 정밀 라우팅 연결하여 `BLOG UNDER CONSTRUCTION` 오패스 에러 완전 해소 완료.
