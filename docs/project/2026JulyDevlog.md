...
* **작업 상세 ([`Sidebar.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/components/layout/Sidebar.tsx))**:
  ...
  - **한글 도메인 (IDN) 퓨니코드(Punycode: `xn--...`) 자동 인코딩 및 실시간 조작/매입 지원 ([`vercel-domains.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/lib/server/vercel-domains.ts), [`domain-search/page.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/app/studio/domain-search/page.tsx))**: `크리에이박스.kr`, `소통채움.com` 등 한글 브랜드 도메인을 검색 시 Node.js `domainToASCII` 국제 표준 퓨니코드로 자동 변환하여 실시간 DNS 조회, 구매 및 이관을 지원하는 한글 IDN 파이프라인 연동 완수.
