...
* **작업 상세 ([`Sidebar.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/components/layout/Sidebar.tsx))**:
  ...
  - **"비즈니스 웹사이트" 멤버십 접근 권한에 "Premiere" 및 하이어 요금제 전면 수록 ([`layout.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/app/studio/client-site-builder/layout.tsx), [`upload/route.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/app/api/client-site-builder/upload/route.ts), [`build/route.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/app/api/client-site-builder/build/route.ts), [`plan/route.ts`](file:///Users/a1234/Local%20Sites/creaibox/src/app/api/client-site-builder/plan/route.ts))**: 기존 "Pro 요금제 이상" 권한 검사 조건문에서 `premiere`/`premier`/`premium`/`master` 등 상위 플랜 키값이 누락되어 프리미어 유저 접속 시 업그레이드 잠금 모달이 차단되던 버그를 정밀 수정하여, Pro 이상의 모든 정기 결제 및 상위 권한 회원이 100% 정상 접속 가능하도록 보완 완료.
