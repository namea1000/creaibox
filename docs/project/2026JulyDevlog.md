...
* **작업 상세 ([`Sidebar.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/components/layout/Sidebar.tsx))**:
  ...
  - **"AI 글쓰기" 메뉴 이동 경로를 "크리에이박스 블로그 > 블로그 새글 쓰기"로 전면 교체 ([`Header.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/components/layout/Header.tsx), [`page.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/app/page.tsx), [`ai-writer/page.tsx`](file:///Users/a1234/Local%20Sites/creaibox/src/app/ai-writer/page.tsx))**: 헤더 메가메뉴 및 메인페이지 퀵 메뉴 바의 "AI 글쓰기" 클릭 시 기존 미사용 라우터 랜딩 페이지(`/ai-writer`)로 이동하던 동선을 "크리에이박스 블로그 > 블로그 새글 쓰기"(`https://creaibox.com/writing/creaibox/new-post`)로 전면 연결 교체하고, 기존 `/ai-writer` 경로 접속 시 즉시 리다이렉트되도록 조치.
